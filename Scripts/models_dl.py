...
def download_textual_inversion_hakoMay_model(model_dir):
    MODEL_ID = "852wa/hakoMay"
    FILES = ["Mayng.safetensors","Mayng.yaml"]
    check_and_download_model(model_dir, MODEL_ID, [], FILES)

def download_textual_inversion_ParaNegative_model(model_dir):
    MODEL_ID = "p1atdev/Realgar-v1"
    FILES = ["ParaNegative.safetensors"]
    check_and_download_model(model_dir, MODEL_ID, [], FILES)
...
if __name__ == "__main__":
    ...
    textual_inversion_hakoMay_path = "Models/textual_inversion/hakoMay"
    download_textual_inversion_hakoMay_model(textual_inversion_hakoMay_path)

    textual_inversion_ParaNegative_path = "Models/textual_inversion/ParaNegative"
    download_textual_inversion_ParaNegative_model(textual_inversion_ParaNegative_path)
